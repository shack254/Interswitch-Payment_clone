...
outward_suspence_account = "KES700000003"
...
def outward_wire_transfer(request):
    with engine.begin() as connection:
        debit_account = AccountDetails.from_account_table(connection,outward_suspence_account)
